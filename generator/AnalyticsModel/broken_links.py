...
def remove_broken_links_documents_clicks(documents_clicks):
    query_counter = 0
...
def remove_broken_links_documents_searches_mapping(documents_searches_mapping, documents_clicks):
    remove_searches = []
